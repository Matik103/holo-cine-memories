            ...
            <div className="flex items-center gap-2 sm:gap-4 min-w-0">
              ...
              <div className="min-w-0">
                <h1 className="text-base sm:text-xl font-bold flex items-center gap-1.5 sm:gap-2">
                  ...
                  <span className="truncate">{t('mystery.collectiveMemory')}</span>
                </h1>
                <p className="text-[10px] sm:text-xs text-muted-foreground truncate">
                  {t('mystery.helpIdentify')}
                </p>
              </div>
            </div>
            <div className="flex items-center gap-2">
              ...
              <div className="sm:hidden">
                <CreateMysteryDialog 
                  onSuccess={refetch}
                  trigger={
                    <Button className="neural-button" size="icon" aria-label={t('mystery.postMystery')}>
          ...
          <Card className="neural-card p-3 sm:p-4">
            ...
            <div className="flex gap-4 overflow-x-auto pb-2 -mx-1 px-1 scrollbar-hide">
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <span className="text-xs whitespace-nowrap">{t('mystery.step1')}</span>
              </div>
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <span className="text-xs whitespace-nowrap">{t('mystery.step2')}</span>
              </div>
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <span className="text-xs whitespace-nowrap">{t('mystery.step3')}</span>
              </div>
            </div>
          </Card>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
          ...
          <div className="lg:col-span-2 space-y-4 sm:space-y-6">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-3">
              <Card className="neural-card p-2 sm:p-3 text-center">
                ...
                <div className="text-[10px] sm:text-xs text-muted-foreground">{t('mystery.unsolved')}</div>
              </Card>
              {isAuthenticated && stats && (
                <>
                  <Card className="neural-card p-2 sm:p-3 text-center">
                    <div className="text-xl sm:text-2xl font-bold text-green-400">{stats.mysteries_solved}</div>
                    <div className="text-[10px] sm:text-xs text-muted-foreground">{t('mystery.yourSolves')}</div>
                  </Card>
                  <Card className="neural-card p-2 sm:p-3 text-center">
                    ...
                    <div className="text-[10px] sm:text-xs text-muted-foreground">{t('mystery.streak')}</div>
                  </Card>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-1">
                      <span className="text-xs font-semibold text-orange-400 uppercase tracking-wide">{t('mystery.hotMystery')}</span>
            ...
            {error && (
              <Card className="neural-card p-4 sm:p-6 text-center" role="alert">
                ...
                <h3 className="font-semibold mb-2 text-sm sm:text-base">{t('mystery.failedToLoad')}</h3>
            ...
            {!isLoading && !error && mysteries.length === 0 && (
              <Card className="neural-card p-6 sm:p-8 text-center">
                ...
                <h3 className="font-semibold mb-2 text-sm sm:text-base">{t('mystery.noMysteries')}</h3>
          ...
          <aside className="hidden lg:block space-y-6">
            ...
            <Card className="neural-card p-4">
              ...
              <ol className="space-y-3 text-sm" aria-label={t('mystery.howItWorks')}>
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    <span className="font-medium">{t('mystery.postMystery')}</span>
                    <p className="text-xs text-muted-foreground">{t('mystery.step1Desc')}</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    <span className="font-medium">{t('mystery.communityHelps')}</span>
                    <p className="text-xs text-muted-foreground">{t('mystery.step2Desc')}</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    <span className="font-medium">{t('mystery.step3')}</span>
                    <p className="text-xs text-muted-foreground">{t('mystery.step3Desc')}</p>
                  </div>
                </li>
              </ol>
            </Card>
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-3 text-center">
                    <div className="p-2 rounded-lg bg-background/50">
                      ...
                      <div className="text-xs text-muted-foreground">{t('mystery.posted')}</div>
                    </div>
                    <div className="p-2 rounded-lg bg-background/50">
                      <div className="text-lg font-bold">{stats.longest_solve_streak}</div>
                      <div className="text-xs text-muted-foreground">{t('mystery.bestStreak')}</div>
                    </div>
                  </div>
                </div>
              </Card>
            ...
            <Card className="neural-card p-4">
              <h2 className="font-semibold mb-3 flex items-center gap-2">
                ...
                {t('mystery.tipsForSolving')}
              </h2>
              <ul className="space-y-2 text-xs text-muted-foreground" aria-label={t('mystery.tipsForSolving')}>
                <li className="flex items-start gap-2">
                  <ThumbsUp className="h-3 w-3 mt-0.5 text-green-400 flex-shrink-0" aria-hidden="true" />
                  <span>{t('mystery.tip1')}</span>
                </li>
                <li className="flex items-start gap-2">
                  <ThumbsUp className="h-3 w-3 mt-0.5 text-green-400 flex-shrink-0" aria-hidden="true" />
                  <span>{t('mystery.tip2')}</span>
                </li>
                <li className="flex items-start gap-2">
                  <ThumbsUp className="h-3 w-3 mt-0.5 text-green-400 flex-shrink-0" aria-hidden="true" />
                  <span>{t('mystery.tip3')}</span>
                </li>
              </ul>
            </Card>
              ...
              {isAuthenticated && vaultStats && (
                <div className="flex items-center gap-3 text-xs">
                  <div className="flex items-center gap-1 px-2 py-1 rounded-full bg-primary/10">
                    ...
                    <span className="text-muted-foreground">{t('mystery.score')}</span>
                  </div>
          ...
          <div className="lg:hidden space-y-4">
              ...
              <Card className="neural-card p-3 sm:p-4">
                ...
                <div className="flex items-center justify-between gap-4">
                  ...
                  <div className="flex gap-4 text-center">
                    <div>
                      <div className="text-lg font-bold">{stats.mysteries_posted}</div>
                      <div className="text-[10px] text-muted-foreground">{t('mystery.posted')}</div>
                    </div>
                    <div>
                      <div className="text-lg font-bold">{stats.longest_solve_streak}</div>
                      <div className="text-[10px] text-muted-foreground">{t('mystery.best')}</div>
                    </div>
                  </div>
                </div>
              </Card>
            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <Vault className="h-4 w-4 text-primary" aria-hidden="true" />
                  <span className="font-semibold text-sm">{t('mystery.theVault')}</span>
                </div>
                <div className="flex items-center gap-2">
                  {isAuthenticated && vaultStats && (
                    <span className="text-xs text-primary font-medium">{vaultStats.vault_score} {t('mystery.pts')}</span>
                  )}
                  <ArrowRight className="h-4 w-4 text-muted-foreground" />
                </div>
              </div>
